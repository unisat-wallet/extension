...
const disclaimStr = `    By clicking the payment button, you will be redirected to moonpay.com, a separate platform owned by a third party, MoonPay. 
    ...
    Wizz Wallet acts solely as a facilitator and does not assume any responsibility for potential losses or damages arising from the use of the credit card payment service.
